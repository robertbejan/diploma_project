function [featFFT, infoFeatFFT, target_class_training] = trainingMatrix(sizeOfFeatFFT,valStart, numOfSensors)
...
if numDirectories == 0
    ...
    featFFT = zeros(sizeOfFeatFFT, valStart*numOfSensors-numOfSensors);
    infoFeatFFT = {};
    for i=1:sizeOfFeatFFT
